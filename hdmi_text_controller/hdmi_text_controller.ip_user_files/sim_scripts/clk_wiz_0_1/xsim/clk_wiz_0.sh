...
#
# Generated by Vivado on Wed Jul 29 09:50:30 -0500 2026
...
simulate()
{
  xsim  clk_wiz_0 -key {Behavioral:sim_1:Functional:clk_wiz_0} -tclbatch cmd.tcl -protoinst "protoinst_files/hdmi_text_controller.protoinst" -log simulate.log
}
