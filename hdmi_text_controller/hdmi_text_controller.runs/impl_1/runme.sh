...
HD_PWD='C:/Users/adamj/Desktop/Vitis/Lab6/hdmi_text_controller/hdmi_text_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_text_controller_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_text_controller_top.tcl -notrace
