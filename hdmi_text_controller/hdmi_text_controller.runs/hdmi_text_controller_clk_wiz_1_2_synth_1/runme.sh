...
HD_PWD='C:/Users/adamj/Desktop/Vitis/Lab6/hdmi_text_controller/hdmi_text_controller.runs/hdmi_text_controller_clk_wiz_1_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_text_controller_clk_wiz_1_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_text_controller_clk_wiz_1_2.tcl
