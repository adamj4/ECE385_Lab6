...
ISEStep( "vivado",
         "-log hdmi_text_controller_hdmi_text_controller_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_text_controller_hdmi_text_controller_0_1.tcl" );
