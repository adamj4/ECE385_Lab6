...
ISEStep( "vivado",
         "-log hdmi_text_controller_ilmb_bram_if_cntlr_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_text_controller_ilmb_bram_if_cntlr_2.tcl" );
