...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ hdmi_text_controller_hdmi_text_controller_0_0_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(hdmi_clk_n, hdmi_clk_p, hdmi_tx_n, hdmi_tx_p, 
  debug_locked, debug_clk25, debug_clk125, debug_drawX, debug_drawY, debug_hsync, debug_vsync, 
...
/* synthesis syn_black_box black_box_pad_pin="hdmi_clk_n,hdmi_clk_p,hdmi_tx_n[2:0],hdmi_tx_p[2:0],debug_locked,debug_clk25,debug_clk125,debug_drawX[9:0],debug_drawY[9:0],debug_hsync,debug_vsync,axi_aclk,axi_aresetn,axi_awaddr[11:0],axi_awprot[2:0],axi_awvalid,axi_awready,axi_wdata[31:0],axi_wstrb[3:0],axi_wvalid,axi_wready,axi_bresp[1:0],axi_bvalid,axi_bready,axi_araddr[11:0],axi_arprot[2:0],axi_arvalid,axi_arready,axi_rdata[31:0],axi_rresp[1:0],axi_rvalid,axi_rready" */;
  ...
  output debug_clk25;
  output debug_clk125;
  output [9:0]debug_drawX;
  output [9:0]debug_drawY;
  output debug_hsync;
  output debug_vsync;
  input axi_aclk;
  input axi_aresetn;
