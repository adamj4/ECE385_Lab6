...
HD_PWD='c:/users/adamj/desktop/vitis/lab6/hdmi_text_controller/hdmi_text_controller.tmp/hdmi_text_controller_v1_0_project/hdmi_text_controller_v1_0_project.runs/clk_wiz_0_synth_1'
cd "$HD_PWD"
