...
HD_PWD='C:/Users/adamj/Desktop/Vitis/Lab6/hdmi_text_controller_2/hdmi_text_controller_2.runs/hdmi_text_controller_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_text_controller_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_text_controller_lmb_bram_0.tcl
