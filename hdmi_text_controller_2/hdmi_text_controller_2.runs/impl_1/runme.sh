...
HD_PWD='C:/Users/adamj/Desktop/Vitis/Lab6/hdmi_text_controller_2/hdmi_text_controller_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_text_controller_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_text_controller_wrapper.tcl -notrace
